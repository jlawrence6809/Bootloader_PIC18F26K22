...
IdTypePIC = 0x66			; must exists in "piccodes.ini"
#define max_flash 0x10000	; in BYTES!!! (= 'max flash memory' from "piccodes.ini")

#define USE_INTOSC	; change frequency at line 94. If you use an external crystal, comment this line!
...
baud EQU 19200			; standard TinyBld baud rates: 115200 or 19200
	...
	;
	; modified by Edorul:
	; EEPROM write is only compatible with "Tiny AVR/PIC Bootloader+"
...
;		CONFIG	OSC = HS, FCMEN = OFF, IESO = OFF
		CONFIG	FOSC = INTIO67, FCMEN = OFF, IESO = OFF	; Use internal oscilator, xtal = 8000000


;----- CONFIG2L Options -----
		CONFIG	PWRTEN = ON, BOREN = ON, BORV = 190


;----- CONFIG2H Options -----
		CONFIG	WDTEN = OFF, WDTPS = 128
